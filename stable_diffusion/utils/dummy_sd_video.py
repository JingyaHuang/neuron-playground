...
pipe = StableVideoDiffusionPipeline(**components)
save_directory = "tiny-stable-video-diffusion-img2vid/"
pipe.save_pretrained(save_directory, safe_serialization=False)